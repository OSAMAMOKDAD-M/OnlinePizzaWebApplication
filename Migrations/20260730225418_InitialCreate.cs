...
namespace OnlinePizzaWebApplication.Migrations
{
    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "LicenseAttempts",
                columns: table => new
                {
                    Id = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    AttemptedAtUtc = table.Column<DateTime>(type: "TEXT", nullable: false),
                    MaskedKey = table.Column<string>(type: "TEXT", maxLength: 60, nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LicenseAttempts", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MaskedKey = table.Column<string>(type: "TEXT", maxLength: 60, nullable: false),
                    ...
                    SingleDevice = table.Column<bool>(type: "INTEGER", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LogoUrl = table.Column<string>(type: "TEXT", maxLength: 400, nullable: true),
